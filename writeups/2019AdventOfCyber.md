...
1. What is the name of the cookie used for authentication?
   ...
   ![screenshot_authid](/room_2019_advent_of_cyber/screenshots/day01/authid.png?raw=true)
...
3. After accessing his account, what did the user mcinventory request?
   ...
   ![screenshot_mcinventory](/room_2019_advent_of_cyber/screenshots/day01/mcinventory.png?raw=true)
...
1. What is the path of the hidden page?
   ...
   ![screenshot_gobuster](/room_2019_advent_of_cyber/screenshots/day02/gobuster.png?raw=true)
...
2. What is the password you found?
   ...
   ![screenshot_source](/room_2019_advent_of_cyber/screenshots/day02/source.png?raw=true)
   ...
   ![screenshot_credentials](/room_2019_advent_of_cyber/screenshots/day02/credentials.png?raw=true)
...
3. What do you have to take to the 'partay'?
   ...
   ![screenshot_BYOE](/room_2019_advent_of_cyber/screenshots/day02/BYOE.png?raw=true)
...
1. Whats the destination IP on packet number 998?
   ...
   ![screenshot_packet_998](/room_2019_advent_of_cyber/screenshots/day03/packet_998.png?raw=true)
...
2. What item is on the Christmas list?
   ...
   ![screenshot_telnet](/room_2019_advent_of_cyber/screenshots/day03/telnet.png?raw=true)
...
3. Crack buddy's password!
   ...
   ![screenshot_shadow](/room_2019_advent_of_cyber/screenshots/day03/shadow.png?raw=true)
...
1. What is Lola's date of birth? Format: Month Date, Year(e.g November 12, 2019)
   ...
   ![screenshot_metdata](/room_2019_advent_of_cyber/screenshots/day05/metadata.png?raw=true)

   *JLolax1* is the creator of the image, a quick google search of the creator led me to the creator's twitter page.

   ![screenshot_twitter](/room_2019_advent_of_cyber/screenshots/day05/twitter.png?raw=true)
...
4. What date did Lola first start her photography? Format: dd/mm/yyyy
   ...
   ![screenshot_wayback](/room_2019_advent_of_cyber/screenshots/day05/wayback.png?raw=true)
...
5. What famous woman does Lola have on her web page?
   ...
   ![screenshot_woman](/room_2019_advent_of_cyber/screenshots/day05/woman.png?raw=true)

   Doing a quick reverse search on the image reveals that she's Ada Lovelace.

   ![screeshot_ada](/room_2019_advent_of_cyber/screenshots/day05/ada.png?raw=true)
...
1. What data was exfiltrated via DNS?
   ...
   ![screenshot_dns](/room_2019_advent_of_cyber/screenshots/day06/dns.png?raw=true)

   I used [CyberChef](https://gchq.github.io/CyberChef/) to decrypt the subdomain and got what I was looking for.

   ![screenshot_cyberchef](/room_2019_advent_of_cyber/screenshots/day06/cyberchef.png?raw=true)
...
2. What did Little Timmy want to be for Christmas?
   ...
   ![screenshot_zip](/room_2019_advent_of_cyber/screenshots/day06/zip.png?raw=true)

   So, I exported the christmasfiles.zip file and tried to unzip it.

   ![screenshot_password](/room_2019_advent_of_cyber/screenshots/day06/password.png?raw=true)
   ...
   ![screenshot_fcrackzip](/room_2019_advent_of_cyber/screenshots/day06/fcrackzip.png?raw=true)

   Now, that I have the password, I was able to unzip the file and see what Little Timmy wants to be for Christmas.

   ![screenshot_christmas_lists](/room_2019_advent_of_cyber/screenshots/day06/christmas_lists.png?raw=true)
...
3. What was hidden within the file?
   ...
   ![screenshot_steghide](/room_2019_advent_of_cyber/screenshots/day06/steghide.png?raw=true)
...
4. What is the name of the file that is accessible on the server you found running?
   ...
   ![screenshot_file](/room_2019_advent_of_cyber/screenshots/day07/file.png?raw=true)
...
[Scan results](https://github.com/pamhrituc/TryHackMe_Writeups/blob/master/room_2019_advent_of_cyber/nmap_scan_results/day8_suid.log)
...
3. Find another binary file that has the SUID bit set. Using this file, can you become the root user and read the /root/flag2.txt file?
   ...
   ![screenshot_find](/room_2019_advent_of_cyber/screenshots/day08/find.png?raw=true)

   system-control

   This binary allows us to use `su` as root.

   ![screenshot_su](/room_2019_advent_of_cyber/screenshots/day08/su.png?raw=true)
...
I wrote a script that resolves this challenge. This script can be found in the [room_2019_advent_of_cyber](https://github.com/pamhrituc/TryHackMe_Writeups/tree/master/room_2019_advent_of_cyber) folder, under the name of [day9_requests.py](https://github.com/pamhrituc/TryHackMe_Writeups/blob/master/room_2019_advent_of_cyber/day9_requests.py).
...
The first thing I've done was use nmap to scan the machine for services said machine runs and the services. [Scan results](https://github.com/pamhrituc/TryHackMe_Writeups/blob/master/room_2019_advent_of_cyber/nmap_scan_results/day10_metaploit.log)
...
![Screenshot_of_struts2](/room_2019_advent_of_cyber/screenshots/day10/struts2.png?raw=true)
...
![Screenshot_of_options](/room_2019_advent_of_cyber/screenshots/day10/options.png?raw=true)
...
![Screenshot_of_reverse_shell](/room_2019_advent_of_cyber/screenshots/day10/reverse_shell.png?raw=true)
...
2. What is the name of the file running on port 21?
   ...
   ![screenshot_file](/room_2019_advent_of_cyber/screenshots/day11/file.png?raw=true)
...
3. What is the password after enumerating the database?
   ...
   ![screenshot_mysql](/room_2019_advent_of_cyber/screenshots/day11/mysql.png?raw=true)

   Now that I've successfully connected to the database, I checked to see what databases we have.

   ![screenshot_db](/room_2019_advent_of_cyber/screenshots/day11/db.png?raw=true)

   We're interested in the *data* database, so let's select it. Next, let's see what tables we have in the database.

   ![screenshot_tables](/room_2019_advent_of_cyber/screenshots/day11/tables.png?raw=true)

   Alright! Now we want to see all entries in the USER table.

   ![screenshot_users](/room_2019_advent_of_cyber/screenshots/day11/users.png?raw=true)
...
1. A web server is running on the target. What is the hidden directory which the website lives on?
   ...
   ![screenshot_gobuster](/room_2019_advent_of_cyber/screenshots/day13/gobuster.png?raw=true)

   The first result gobuster returns is */retro*. If we access *http://10.10.24.100/retro*, the browser will display this page.

   ![screenshot_retro](/room_2019_advent_of_cyber/screenshots/day13/retro.png?raw=true)
...
2. Gain initial access and read the contents of user.txt
   ...
   ![screenshot_creds](/room_2019_advent_of_cyber/screenshots/day13/creds.png?raw=true)
...
1. What is the name of the file you found?
   ...
   ![screenshot_bucket](/room_2019_advent_of_cyber/screenshots/day14/bucket.png?raw=true)
...
2. What is in the file?
   ...
   ![screenshot_file](/room_2019_advent_of_cyber/screenshots/day14/file.png?raw=true)
...
1. What is Charlie going to book a holiday to?
   ...
   ![screenshot_notes](/room_2019_advent_of_cyber/screenshots/day15/notes.png?raw=true)
...
2. Read /etc/shadow and crack Charlies password.
   ...
   ![screenshot_script](/room_2019_advent_of_cyber/screenshots/day15/script.png?raw=true)
   ...
   ![screenshot_burpsuit](/room_2019_advent_of_cyber/screenshots/day15/burpsuite.png?raw=true)

   Then forward it to the browser and voila!

   ![screenshot_shadow](/room_2019_advent_of_cyber/screenshots/day15/shadow.png?raw=true)
   ...
   ![screenshot_password](/room_2019_advent_of_cyber/screenshots/day15/password.png?raw=true)
...
Just as mentioned in the task, I wrote a python script to solve all three of the questions. The script is [here](https://github.com/pamhrituc/TryHackMe_Writeups/blob/master/room_2019_advent_of_cyber/day16/day16_file_confusion.py).
...
1. What is the admin's authid cookie value?
   ...
   ![screenshot_message](/room_2019_advent_of_cyber/screenshots/day18/message.png?raw=true)
   ...
   ![screenshot_nc](/room_2019_advent_of_cyber/screenshots/day18/nc.png?raw=true)
...
![Screenshot_cookie](/room_2019_advent_of_cyber/screenshots/day19/cookie.png?raw=true)
...
![screenshot_cmd](/room_2019_advent_of_cyber/screenshots/day19/cmd.png?raw=true)

Alright. But the file exists for sure. I supplied the `ls` parameter and this is what I got:

![screenshot_ls](/room_2019_advent_of_cyber/screenshots/day19/ls.png?raw=true)
...
![screenshot_find](/room_2019_advent_of_cyber/screenshots/day19/find.png?raw=true)

Now that we have the location of the file, all we need to to is execute the `cat` command and we have the flag.

![screenshot_flag](/room_2019_advent_of_cyber/screenshots/day19/flag.png?raw=true)
...
3. Escalate your privileges by taking advantage of a cronjob running every minute. What is flag2?
   ...
   ![screenshot_home](/room_2019_advent_of_cyber/screenshots/day20/home.png?raw=true)

   ![screenshot_scripts](/room_2019_advent_of_cyber/screenshots/day20/scripts.png?raw=true)
...
![screenshot_r2_main](/room_2019_advent_of_cyber/screenshots/day21/r2_main.png?raw=true)
...
![screenshot_r2_if](/room_2019_advent_of_cyber/screenshots/day22/r2_if.png?raw=true)
...
I've written the equivalent [c code](https://github.com/pamhrituc/TryHackMe_Writeups/blob/master/room_2019_advent_of_cyber/day22/if2.c) for better understanding.
...
2. What is Santa Claus' email address?
   ...
   ![screenshot_dbs](/room_2019_advent_of_cyber/screenshots/day23/dbs.png?raw=true)
   ...
   ![screenshot_tables](/room_2019_advent_of_cyber/screenshots/day23/tables.png?raw=true)
   ...
   ![screenshot_users](/room_2019_advent_of_cyber/screenshots/day23/users.png?raw=true)
...
4. Santa has a secret! Which station is he meeting Mrs Mistletoe in?
   ...
   ![screenshot_messages](/room_2019_advent_of_cyber/screenshots/day23/messages.png?raw=true)
...
5. Once you're logged in to LapLANd, there's a way you can gain a shell on the machine! Find a way to do so and read the file in /home/user/
   ...
   ![screenshot_flag](/room_2019_advent_of_cyber/screenshots/day23/flag.png?raw=true)
...
1. Find the password in the database.
   ...
   First things first, I scanned the machine using nmap (`nmap -sV -p- 10.10.171.70`). [Scan results](https://github.com/pamhrituc/TryHackMe_Writeups/blob/master/room_2019_advent_of_cyber/nmap_scan_results/day24_elf_stalk.log)
   ...
   ![screenshot_password](/room_2019_advent_of_cyber/screenshots/day24/password.png?raw=true)
...
2. Read the contents of the */root.txt* file.
   ...
   ![screenshot_kibana](/room_2019_advent_of_cyber/screenshots/day24/kibana.png?raw=true)
   ...
   ![screenshot_log](/room_2019_advent_of_cyber/screenshots/day24/log.png?raw=true)
